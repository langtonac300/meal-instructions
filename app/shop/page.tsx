  ...
  return (
    <CartProvider>
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-8 sm:py-16 space-y-12">
        ...
        {/* Field Deployment / Lookbook Section */}
        <div className="hairline-t pt-12 space-y-6">
          <div className="space-y-1">
            <div className="micro-label text-ink-muted">IN SITU DEPLOYMENT</div>
            <h2 className="text-2xl font-bold uppercase tracking-tight text-ink font-sans">
              Authentic Field Testing
            </h2>
            <p className="text-xs text-ink-muted font-mono">
              Tested on real weeknights in real suburban kitchens. No glossy studio actors.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {/* Model 1 */}
            <div className="bg-paper-card hairline-border overflow-hidden group">
              <div className="relative aspect-square">
                <Image
                  src="/images/merch/skip-to-recipe-model.jpg"
                  alt="Dave (38) wearing Skip to Recipe tee with air fryer"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, 25vw"
                />
              </div>
              <div className="p-3 font-mono text-xs space-y-1 bg-paper-card">
                <div className="font-bold text-ink uppercase">SPEC // SKIP TO RECIPE TEE</div>
                <div className="text-[11px] text-ink-muted">
                  Dave (38), weeknight air fryer nugget extraction unit
                </div>
              </div>
            </div>
            ...
            <div className="bg-paper-card hairline-border overflow-hidden group">
              <div className="relative aspect-square">
                <Image
                  src="/images/merch/tongs-protocol-model.jpg"
                  alt="Mark (40) wearing Tongs Protocol tee at grill"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, 25vw"
                />
              ...
              <div className="p-3 font-mono text-xs space-y-1 bg-paper-card">
                <div className="font-bold text-ink uppercase">SPEC // TONGS PROTOCOL TEE</div>
                <div className="text-[11px] text-ink-muted">
                  Mark (40), verifying 85dB acoustic double-click at kettle
                </div>
              </div>
            </div>
            ...
            <div className="bg-paper-card hairline-border overflow-hidden group">
              <div className="relative aspect-square">
                <Image
                  ...
                  alt="Brad (42) wearing Inverted Cheatsheet Apron"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, 25vw"
                />
              ...
              <div className="p-3 font-mono text-xs space-y-1 bg-paper-card">
                <div className="font-bold text-ink uppercase">SPEC // INVERTED APRON</div>
                <div className="text-[11px] text-ink-muted">
                  Brad (42), reading upside-down ratio while simmering sauce
                </div>
              </div>
            </div>
            ...
            <div className="bg-paper-card hairline-border overflow-hidden group">
              <div className="relative aspect-square">
                <Image
                  ...
                  alt="Master Temp Towel hanging on oven handle"
                  fill
                  className="object-cover"
                  sizes="(max-width: 768px) 100vw, 25vw"
                />
              ...
              <div className="p-3 font-mono text-xs space-y-1 bg-paper-card">
                <div className="font-bold text-ink uppercase">SPEC // TEMP MATRIX TOWEL</div>
                <div className="text-[11px] text-ink-muted">
                  Standard oven-handle hanging deployment (18&quot; × 28&quot;)
                </div>
              </div>
            </div>
