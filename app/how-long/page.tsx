...
export const metadata: Metadata = {
  ...
  description:
    `${COOK_TIME_DATASHEETS.length} verified cook-time datasheets for air fryer, skillet, sheet pan, cast iron, grill, slow cooker, and smoker. Exact temps, flip marks, and internal targets.`,
  alternates: {
