...
export default {
  ...
  "ingredients": [
    {
      "item": "St. Louis Style Pork Ribs",
      "qty": "2",
      "qtyNumeric": 2,
      "unit": "racks",
      "notes": "approx 5-6 lbs total"
    },
    {
      "item": "BBQ Pork Dry Rub",
      "qty": "1/3",
      "qtyNumeric": 0.33,
      "unit": "cups"
    },
  ...
  "keywords": [
    "smoked ribs 321",
    "st louis pork ribs pellet grill",
    "traeger ribs recipe",
    "best smoked ribs dad"
  ],
